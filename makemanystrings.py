...
redis_proxy = redis.Redis(host='redis-18031.mc290-0.us-central1-mz.gcp.cloud.rlrcp.com', port=18031, password='C2iadH1hasCAk1zrHKj2nLwYrI0GvzdMn', decode_responses=True)
